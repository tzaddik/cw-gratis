<?php
/**
* @package   cw_gratis_w7
* @author    Coalaweb http://www.coalaweb.com
* @copyright Copyright (C) Coalaweb
...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    ...
    <div class="tm-top uk-clearfix uk-hidden-small">
        <div class="uk-container uk-container-center">
    ...
    <div class="tm-bottom uk-clearfix uk-hidden-small">
        <div class="uk-container uk-container-center">
